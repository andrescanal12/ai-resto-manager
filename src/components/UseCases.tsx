...
const UseCasesFixed = () => {
  const cases = [
    ...
    },
    {
      ...
      image: "/marketing_digital_futurista.png",
      video: "/video_agente3.mp4",
            ...
            return (
              ...
              >
                ...
                <div className={`${useCase.reverse ? "lg:col-start-1" : ""}`}>
                  <div className="group relative bg-gradient-to-br from-card to-secondary rounded-2xl p-6 md:p-8 shadow-[var(--shadow-card)] border border-border">
                    {useCase.video ? (
                      ...
                      <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl flex items-center justify-center mx-auto">
